...
describe('Clase BooksClass', () => {
  ...
  test('booksFromUser devuelve un objeto BooksClass con los 2 libros del usuario 2', () => {
  ...
  test('booksFromUser devuelve un objeto BooksClass vacío para el usuario 12', () => {
    const response = books.booksFromUser(12)
    expect(response).toBeInstanceOf(Books)
    expect(response.data).toEqual([])
  })

  test('booksFromModule devuelve un objeto BooksClass con los 2 libros del módulo ABCD', () => {
